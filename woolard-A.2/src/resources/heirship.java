...
public class heirship {
	ArrayList<String> pZip = new ArrayList<String>(); ArrayList<String> Zip= new ArrayList<String>(); ArrayList<String> State= new ArrayList<String>(); ArrayList<String> City= new ArrayList<String>(); ArrayList<String> Address= new ArrayList<String>(); ArrayList<String> Name= new ArrayList<String>(); ArrayList<String> Value= new ArrayList<String>(); ArrayList<String> pState= new ArrayList<String>(); ArrayList<String> pCity= new ArrayList<String>(); ArrayList<String> pAddress= new ArrayList<String>(); ArrayList<String> Decedent= new ArrayList<String>(); ArrayList<String> County = new ArrayList<String>(); ArrayList<String> Date= new ArrayList<String>();
